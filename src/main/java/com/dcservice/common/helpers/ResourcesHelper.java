...
public class ResourcesHelper  extends BaseHelper  {
	...
	public static String getString(String bundle, String resourceId,
		...
		String appBundle = FacesContext.getCurrentInstance().getApplication()
				.getMessageBundle();
		ClassLoader loader = getClassLoader();
		return getString(appBundle, bundle, resourceId, FacesContext.getCurrentInstance().getApplication().getDefaultLocale(),
				loader, params);
	}

	public static String getEnums(String bundle, String resourceId,
			Object[] params) {
		String appBundle = FacesContext.getCurrentInstance().getApplication()
				.getMessageBundle();
		ClassLoader loader = getClassLoader();
	...
	public static String getEnums(String bundle1, String bundle2,
			String resourceId, Locale locale, ClassLoader loader,
			Object[] params) {
		String resource = null;
		ResourceBundle bundle;
